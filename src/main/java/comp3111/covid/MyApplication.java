...
public class MyApplication extends Application {
	...
	public void start(Stage stage) throws Exception {
		DataAnalysis.data.preprocess("COVID_Dataset_v1.0.csv");
		DataAnalysis.processRateOfVaccination();
    	...
    	loader.setLocation(getClass().getResource(UI_FILE));
   		...
   		stage.setTitle("T-06: Data Explorer on COVID-19");
   		stage.show();
	}
	...
	public static boolean main(String args[]) {
		data = new Data();
   		data.preprocess("COVID_Dataset_v1.0.csv");
   		try {
